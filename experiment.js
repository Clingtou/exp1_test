  ...
  return {
    ...
    stimulus: shellHtml(`
      <form id="post-open-form" novalidate>
        <h2 class="intro-title">Follow-up Questions</h2>
        <div class="form-question">
          <label class="question-text" for="study-issue-comment">Please let us know if you experienced any issues or had any questions about the study you just completed.</label>
          <textarea id="study-issue-comment" class="text-area" name="study_issue_comment"></textarea>
        </div>
        <button type="submit" class="form-submit">Submit</button>
